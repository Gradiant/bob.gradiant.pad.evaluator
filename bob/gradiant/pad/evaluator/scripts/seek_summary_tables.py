...
def main():
    ...
    parser.add_argument('-bp', '--base_path', type=str, dest='base_path', help='From this base path, this scripy seeks recursively', required=True)
    parser.add_argument('-rp', '--result_path', type=str, dest='result_path', help='result_path', required=True)
    ...
    if len(list_summary_table_filename) == 0:
        raise IOError('There is no summary_tables here ['+ args.base_path + ']')
